...
const DEFAULT_USERS=[
{email:"rini@rml.app",loginName:"rini",active:true,phone:"085668027045",name:"Rini",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"lisna@rml.app",loginName:"lisna",active:true,phone:"085218600582",name:"Lisna",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"septino@rml.app",loginName:"septino",active:true,phone:"08116946999",name:"Septino",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"admin@rml.app",loginName:"admin",active:true,phone:"082284879722",name:"Admin",role:"admin",***REMOVED***,mustChangePassword:true}];
function loadUsers(){
 try{
