...
const DEFAULT_USERS=[
{email:"rini@rml.app",loginName:"rini",active:true,phone:"PHONE_RINI",name:"Rini",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"lisna@rml.app",loginName:"lisna",active:true,phone:"PHONE_LISNA",name:"Lisna",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"septino@rml.app",loginName:"septino",active:true,phone:"PHONE_SEPTINO",name:"Septino",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"admin@rml.app",loginName:"admin",active:true,phone:"PHONE_ADMIN",name:"Admin",role:"admin",***REMOVED***,mustChangePassword:true}];
function loadUsers(){
 try{
