...
const DEFAULT_USERS=[
{email:"rini@rml.app",phone:"PHONE_RINI",name:"Rini",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"lisna@rml.app",phone:"PHONE_LISNA",name:"Lisna",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"septino@rml.app",phone:"PHONE_SEPTINO",name:"Septino",role:"sales",***REMOVED***,mustChangePassword:true},
{email:"admin@rml.app",phone:"PHONE_ADMIN",name:"Administrator",role:"admin",***REMOVED***,mustChangePassword:true}];
function loadUsers(){
 try{
