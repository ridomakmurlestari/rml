...
async function saveProductFromModal(){
 ...
 const payload={code:document.getElementById('productModalCodeInput').value.trim(),name,category,price:Math.round(price),discount,active:document.getElementById('productModalActiveInput').checked};
 let message='';
 if(id){
