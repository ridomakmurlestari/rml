...
-- RML v1.8.42 EGRESS FIX
-- Reconciliation must not download payload/jsonb/photos.
-- Run once in Supabase SQL Editor.
create or replace function public.app_pull_visit_ids(p_token text,p_limit integer default 5000)
...
grant execute on function public.app_pull_visit_ids(text,integer) to anon, authenticated;
