...
function openApp(){
 ...
 document.getElementById("priceListNavBtn")?.classList.toggle("hidden",currentUser.role==="admin");
...
if("serviceWorker" in navigator&&location.protocol.startsWith("http")){
 window.addEventListener("load",async()=>{
  try{
   const registration=await navigator.serviceWorker.register("./service-worker.js?v=1.6.1",{updateViaCache:"none"});
