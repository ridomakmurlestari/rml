/* RML Sales Visit v1.8.41 - Target Reward (Percent / Nominal) */
(function(){
...
function rewardHtml(x){if(!x.rewardType||x.rewardType==='none'||Number(x.rewardValue||0)<=0)return '';const full=rewardBaseAmount(x);return `<div class=\"target-reward-box\"><div><small>Reward jika capai 100%</small><strong>${money(full)}</strong></div></div>`}
